...
public class TankPlayer2 extends Tank implements KeyListener {
    ...
    public static void setTankColor(int tankColor) {
        TankPlayer2.tankColor = tankColor;
    }
     ...
     * @param good 坦克的属性
     */
    public TankPlayer2(int x, int y, boolean good) {
        this.x = x;
        this.y = y;
        this.good = good;
        this.oldX = x;
     ...
     */
    public TankPlayer2(int x, int y, boolean good, Direction direction) {
        this(x, y, good);
        this.direction = direction;
    }
